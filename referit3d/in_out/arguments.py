...
-scannet-file /home/eslam/scannet_dataset/scannet/scan_4_nr3d/keep_all_points_00_view_no_global_scan_alignment_saveJPG.pkl -referit3D-file /home/eslam/scannet_dataset/scannet/nr3d.csv --log-dir ../log/referit3d_r18_32_loadimgs --n-workers 8 --batch-size 16 -load-imgs True --img-encoder True --object-encoder r18 -load-dense False
"""
...
def parse_arguments(notebook_options=None):
    ...
    parser.add_argument('-load-dense', type=str2bool, required=True, default=False)  # eslam
    parser.add_argument('-load-imgs', type=str2bool, required=True, default=False)  # eslam
    parser.add_argument('--img-encoder', type=str2bool, required=True, default=False)  # eslam
    parser.add_argument('--imgsize', default=32, type=int, help='Size of projected image')  # eslam
    parser.add_argument('--train-vis-enc-only', default=False, type=str2bool, help='train visual encoder only')  # eslam
    parser.add_argument('--cocoon', default=False, type=str2bool,
                        help='train visual encoder using cocoon setup')  # eslam
    parser.add_argument('--twoStreams', default=False, type=str2bool, help='train using raw PC & 2d Images')  # eslam
